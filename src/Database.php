...
class Database
{
    ...
    public function getSearchCount(string $phrase): int
    {
        try {   
            ...
            if ($result === false) {
                throw new StorageException('Błąd przy pobieraniu ilości notatek, 400');
            }

            return (int) $result['cn'];
        } catch(Throwable $e) {
            throw new StorageException('Nie udało się pobrać informacji o liczbie szukanych notatek', 400, $e);
        }
    }
